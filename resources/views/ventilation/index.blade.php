      ...
      <div class="card">
                  ...
                  <div class="card bg-gradient-default shadow">
                      <div class="card-header bg-transparent">
                          <div class="row align-items-center">
                              <div class="col">
                                  <h2 class="text-uppercase ls-1 mb-1">Ventilation Control</h2>
                              </div>
                          </div>
                      </div>
                      <div class="card-body">
                          ...
                          <div class="chart">
                            <div class="card card-stats col-sm-10 col-lg-10 text-center">
                              <div class="card-body">
                                          ...
                                          <span class="h2 font-weight-bold mb-0">{{number_format($fieldTemperatureAir, 2, '.', ',')}} °C</span>
                              </div>
                          </div>
                          <div class="card card-stats col-sm-10 col-lg-10 text-center">
                            <div class="card-body">
        ...
        <div class="row justify-content-center" style="margin-top:10px"> 
          ...
          <div class="col-sm-8 col-lg-4">
            <iframe width="450" height="260" style="border: 0px solid #cccccc;" src="https://thingspeak.com/channels/1690055/widgets/454611"></iframe>
          </div>
            ...
            <div class="chart">
              <div class="card card-stats col-sm-8 col-lg-8 text-center">
                <div class="card-body">
                      ...
                      <br>
                      <form action="{{ route('manualVentilation.storedata') }}" method="post">
                      @csrf
            ...
            <div class="card card-stats col-sm-8 col-lg-8 text-center">
              <div class="card-body">
                <div class="col-sm-8 col-lg-8">
                  ...
                  <br>
                  <form action="{{ route('automationVentilation.storedata') }}" method="post">
                    @csrf
        ...
        <div class="row justify-content-center" style="margin-top:10px"> 
          ...
          <div class="col-sm-8 col-lg-4">
            <iframe width="450" height="260" style="border: 0px solid #cccccc;" src="https://thingspeak.com/channels/1690058/widgets/454612"></iframe>
          </div>
            ...
            <div class="chart">
              <div class="card card-stats col-sm-8 col-lg-8 text-center">
                <div class="card-body">
                      ...
                      <br>
                      <form action="{{ route('onManualVentilation.storedata') }}" method="post">
                        @csrf
            ...
            <div class="card card-stats col-sm-8 col-lg-8 text-center">
              <div class="card-body">
                <div class="col-sm-8 col-lg-8">
                  ...
                  <br>
                  <form action="{{ route('offManualVentilation.storedata') }}" method="post">
                    @csrf
